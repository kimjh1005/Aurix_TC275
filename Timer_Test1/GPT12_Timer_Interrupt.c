...
/*********************************************************************************************************************/
/*------------------------------------------------------Macros-------------------------------------------------------*/
#define ISR_PRIORITY_GPT12_TIMER2    5
/*********************************************************************************************************************/
#define ISR_PRIORITY_GPT12_TIMER3    6                       /* Define the GPT12 Timer interrupt priority            */
#define ISR_PRIORITY_GPT12_TIMER     5
#define ISR_PROVIDER_GPT12_TIMER    IfxSrc_Tos_cpu0         /* Interrupt provider                                   */
#define RELOAD_VALUE                9767u                  /* Reload value to have an interrupt each 500ms         */
#define RELOAD_VALUE_T2             9767u
#define RELOAD_VALUE_T3             19563u
...
void initGpt12Timer(void)
{
    ...
    //IfxGpt12_T2_setMode(&MODULE_GPT120, IfxGpt12_Mode_timer);                       /* Set T3 to timer mode         */
    //IfxGpt12_T2_setTimerDirection(&MODULE_GPT120, IfxGpt12_TimerDirection_down);    /* Set T3 count direction       */
    //IfxGpt12_T2_setTimerPrescaler(&MODULE_GPT120, IfxGpt12_TimerInputPrescaler_64); /* Set T3 input prescaler       */
    //IfxGpt12_T2_setTimerValue(&MODULE_GPT120, RELOAD_VALUE_T2);                        /* Set T3 start value           */
    ...
    IfxGpt12_T3_setTimerPrescaler(&MODULE_GPT120, IfxGpt12_TimerInputPrescaler_128); /* Set T3 input prescaler       */
...
void interruptGpt12_T2(void)
{
   // IfxGpt12_T3_setTimerValue(&MODULE_GPT120, RELOAD_VALUE/10);                        /* Set T3 start value           */
    ...
    IfxGpt12_T2_setTimerValue(&MODULE_GPT120, RELOAD_VALUE_T2);
}
